...
public static partial class Extensions
{
    ...
    /// <returns>A T.</returns>
    public static T ExecuteEntity<T>(this SQLiteConnection @this, string cmdText, SQLiteParameter[] parameters,
    ...
    /// <param name="transaction">The transaction.</param>
    /// <returns>A T.</returns>
    public static T ExecuteEntity<T>(this SQLiteConnection @this, string cmdText, SQLiteTransaction transaction)
        where T : new()
    {
    ...
    /// <param name="commandType">Type of the command.</param>
    /// <returns>A T.</returns>
    public static T ExecuteEntity<T>(this SQLiteConnection @this, string cmdText, CommandType commandType)
        where T : new()
    {
