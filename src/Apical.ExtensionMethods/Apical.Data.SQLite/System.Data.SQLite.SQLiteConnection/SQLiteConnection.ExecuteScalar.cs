...
public static partial class Extensions
{
    ...
    public static object ExecuteScalar(this SQLiteConnection @this, string cmdText, SQLiteParameter[] parameters,
    ...
    /// <returns>An object.</returns>
    public static object ExecuteScalar(this SQLiteConnection @this, Action<SQLiteCommand> commandFactory)
    {
        using var command = @this.CreateCommand();
    ...
    /// <param name="cmdText">The command text.</param>
    /// <returns>An object.</returns>
    public static object ExecuteScalar(this SQLiteConnection @this, string cmdText)
    {
    ...
    /// <param name="transaction">The transaction.</param>
    /// <returns>An object.</returns>
    public static object ExecuteScalar(this SQLiteConnection @this, string cmdText, SQLiteTransaction transaction)
    {
    ...
    /// <param name="commandType">Type of the command.</param>
    /// <returns>An object.</returns>
    public static object ExecuteScalar(this SQLiteConnection @this, string cmdText, CommandType commandType)
    {
