...
public static partial class Extensions
{
    ...
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this SQLiteConnection @this, string cmdText,
        SQLiteParameter[] parameters, CommandType commandType, SQLiteTransaction transaction)
    {
    ...
    ///     An enumerator that allows foreach to be used to process execute expando objects in this collection.
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this SQLiteConnection @this,
        Action<SQLiteCommand> commandFactory)
    {
        using var command = @this.CreateCommand();
    ...
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this SQLiteConnection @this, string cmdText,
        SQLiteParameter[] parameters, SQLiteTransaction transaction)
    {
    ...
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this SQLiteConnection @this, string cmdText,
        SQLiteParameter[] parameters, CommandType commandType)
    {
