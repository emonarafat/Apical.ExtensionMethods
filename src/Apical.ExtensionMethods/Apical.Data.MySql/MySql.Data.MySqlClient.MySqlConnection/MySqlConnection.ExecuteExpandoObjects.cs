...
public static partial class Extensions
{
    ...
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this MySqlConnection @this, string cmdText,
        MySqlParameter[] parameters, CommandType commandType, MySqlTransaction transaction)
    {
    ...
    ///     An enumerator that allows foreach to be used to process execute expando objects in this collection.
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this MySqlConnection @this,
        Action<MySqlCommand> commandFactory)
    {
        using var command = @this.CreateCommand();
    ...
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this MySqlConnection @this, string cmdText,
        MySqlParameter[] parameters, MySqlTransaction transaction)
    {
    ...
    /// </returns>
    public static IEnumerable<dynamic> ExecuteExpandoObjects(this MySqlConnection @this, string cmdText,
        MySqlParameter[] parameters, CommandType commandType)
    {
